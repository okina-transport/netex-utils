...
## TOPO PLaces departements
#UploadNetexFile "deps" "deps.xml" "importType=INITIAL&skipOutput=false"

## Tous les topo places
#UploadNetexFile "all_topo_places" "naq-all-topo-places-20180131.xml" "importType=INITIAL&skipOutput=false"
...
#
### Grand Poitiers
UploadNetexFile "VIT" "_VIT_shared_data_20180306.xml" "importType=MERGE&forceStopType=ONSTREET_BUS&skipOutput=false"
#
### Perigueux Agglo
...
#
## Libourne
#UploadNetexFile "LIB" "_LIB_shared_data.xml" "importType=MERGE&forceStopType=ONSTREET_BUS&skipOutput=false"
#
## Villeneuve
#UploadNetexFile "VIL" "_VIL_shared_data.xml" "importType=MERGE&forceStopType=ONSTREET_BUS&skipOutput=false"
#
## Bassin d'archachon
#UploadNetexFile "BDA" "_BDA_shared_data.xml" "importType=MERGE&forceStopType=ONSTREET_BUS&skipOutput=false"
#
### Agen
#UploadNetexFile "AGE" "_AGE_shared_data.xml" "importType=INITIAL&forceStopType=ONSTREET_BUS&skipOutput=false"
